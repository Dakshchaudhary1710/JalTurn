 ...
 * Calibrated for Indian agro-climatic zones and common irrigation regimes.
 * 
 * Growth Stages:
 * 1. Initial (L_ini): Germination to 10% ground cover
 * 2. Crop Development (L_dev): 10% cover to effective full cover & flowering onset
 * 3. Mid-Season (L_mid): Flowering, fruit set, grain filling (MOST WATER-SENSITIVE)
 * 4. Late-Season (L_late): Maturation to harvest / senescence
 */
...
export const CROPS = {
  wheat: {
    ...
    stages: {
      initial: {
        ...
        endDay: 20,
        kc: 0.4,
        criticality: 95, // CRI is notoriously critical in wheat
      ...
      midSeason: {
        ...
        endDay: 100,
        kc: 1.15,
        criticality: 92, // Peak moisture demand
  ...
  paddy: {
    ...
    stages: {
      ...
      midSeason: {
        ...
        endDay: 105,
        kc: 1.35,
        criticality: 98, // Extreme sensitivity to moisture stress
  ...
  sugarcane: {
    ...
    stages: {
      initial: {
        ...
        kc: 0.5,
        criticality: 65,
        description: "Sprouting of setts and early root development.",
        sensitivityRank: "Moderate"
      },
      development: {
        name: "Tillering & Early Formative",
        durationDays: 75,
        startDay: 46,
        endDay: 120,
        kc: 0.85,
        criticality: 84,
        description: "Formative phase — determining shoot population per clump.",
        sensitivityRank: "High"
      },
      midSeason: {
        ...
        kc: 1.25,
        criticality: 93,
        description: "Rapid internode expansion and sugar accumulation.",
        sensitivityRank: "Critical"
      },
      lateSeason: {
        name: "Ripening & Sugar Synthesis",
        durationDays: 60,
        startDay: 301,
        endDay: 360,
        kc: 0.75,
        criticality: 35,
        description: "Water restriction increases sucrose percentage.",
        sensitivityRank: "Low"
      }
    },
    irrigationIntervalDays: 12,
    optimalWaterDepthMm: 75
  },
  ...
  potato: {
    ...
    optimalWaterDepthMm: 45
  }
};

/**
 * Returns list of available crops for dropdowns
 */
